...
public class Activity_Reg extends AppCompatActivity {
    ...
    private void signUp(String email, String password) {
        final ProgressDialog progressDialog = new ProgressDialog(Activity_Reg.this);
    ...
    private void goToMainActivity() {
        Intent intent = new Intent(Activity_Reg.this,MainActivity.class);
    ...
    private UsersModel buildNewUser() {
