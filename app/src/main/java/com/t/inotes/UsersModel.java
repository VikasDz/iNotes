...
public class UsersModel {
    ...
    public UsersModel(String displayName, String email,long createdAt,int compMarksB,int compMarksI,int compMarksE,int hardwareMarksB,int hardwareMarksI,int hardwareMarksE,int osMarksB,int osMarksI,int osMarksE,int finalMarks) {
